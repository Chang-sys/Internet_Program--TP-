...
<template>
    ...
    <form class="modal-content" @submit="registerNewUser">
        <div class="container">
            <h1>Sign Up</h1>
            <p>Please fill in this form to create an account.</p>
            <hr>
            <label for="email"><b>Email</b></label>
            <input type="text" placeholder="Enter Email" id="email" v-model="email" required>
            ...
            <input type="password" placeholder="Create your Password" id="password" v-model="password" required>

            <p>By creating an account you agree to our <a hid="#" style="color:dodgerblue">Terms & Privacy</a>.</p>
            <div class="btn">
