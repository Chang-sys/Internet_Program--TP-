...
<template >
  <main class="relative">
        ...
        <tr v-for="product in products" :key="product.name">
          ...
          <td>
            <div class="flex flex-col space-y-2">
              ...
              <button v-on:click="onSelectProduct(product), onEdit()"
                class="hover:text-green-600 hover:font-bold">Edit</button>
              <button v-on:click="onSelectProduct(product), onDelete()" class="hover:text-green-600 hover:font-bold">
                Delete
              </button>
              <button v-on:click="onSelectProduct(product), priceModalShown = true"
    ...
    <div id="overlay" v-if="priceModalShown && selectedProduct" class="
        popupForm
        flex
        justify-center
        items-center
