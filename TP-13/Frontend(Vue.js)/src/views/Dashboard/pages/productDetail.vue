...
export default{
    ...
    async created() {
        ...
        this.products = await productApi.findById(id);
    },
    methods:{
        onSelectProduct(){
        ...
        async onAddPrice(e) {
            ...
            this.products = await productApi.findById(selectedProduct);
    ...
    <main class="relative border-collapse border-[5px] gap-y-4 flex flex-col" v-if="products">
        ...
        <div class="flex w-full" v-for="product in products" :key="product._id">
            <div class="w-[200px] h-[180px] rounded-full border-2 flex justify-center items-center">
                <img class="w-fit h-fit mt-3" :src="'http://localhost:3001/upload/'+product.imageUrl" alt="">
            </div>
        ...
        <div class="w-full ">
            <div class="w-full flex flex-col items-center justify-center">
                ...
                <button class="bg-blue-500 text-white p-1 px-2 rounded-md hover:text-green-600 hover:font-bold p-2 border-[2px]" @click="onSelectProduct()">Add new price</button>
            </div>
            <div>
